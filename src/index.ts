...
export { ToolRegistry, createDefaultRegistry, ToolError } from "./core/tool-registry.js";
export { SessionStore } from "./core/session.js";
export { McpToolBridge } from "./core/mcp-bridge.js";
export type { McpServerConfig, McpTool, McpToolCallResult } from "./core/mcp-bridge.js";
export {
  MAX_FILE_CHARS,
...
export type { SystemPromptLayers, SkillSummary, MemoryEntry, RuntimeInfo } from "./context/builder.js";
export { ContextCompactor, microCompact } from "./context/compaction.js";
export type { CompactionResult } from "./context/compaction.js";
export { PromptCache } from "./context/cache.js";
...
export type { Skill, SkillFrontmatter, SkillSummary as SkillSummaryType } from "./intelligence/skills.js";

// Channels
export { CLIChannel } from "./channels/cli.js";
export { Gateway } from "./channels/gateway.js";
export type { InboundMessage, OutboundMessage, Channel } from "./channels/base.js";
...
export type { SubagentResult, SubagentOptions } from "./collaboration/subagent.js";
...
export type { ScanResult as MemoryScanResult, ScanFinding as MemoryScanFinding } from "./evolution/memory-scan.js";
export { NudgeEngine } from "./evolution/nudge.js";

// Evaluation
export { DeterministicGrader, HeuristicGrader, LLMJudgeGrader, EvalRunner } from "./evaluation/graders.js";
...
export type { PermissionRule, PermissionDecision, PermissionRequest, PermissionResult } from "./security/permissions.js";
export { InjectionDefense } from "./security/injection.js";
export type { ScanResult as InjectionScanResult, InjectionRisk, InjectionFinding } from "./security/injection.js";
